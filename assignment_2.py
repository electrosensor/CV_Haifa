...
#        images that were incorrectly classified as NON-object (false negatives / miss).
        ...
        # Airplanes:
        # FP[] = act == 1 || 2 and exp == 0
        # FN[] = act == 0 and exp == 1 || 2
...
for i in range(0, len(act_labels)):
    if (act_labels[i] == 1 or act_labels[i] == 2) and (exp_labels[i] == 0):
        air_FN.append(i)
    elif (act_labels[i] == 0) and (exp_labels[i] == 1 or exp_labels[i] == 2):
        air_FP.append(i)
    if (act_labels[i] == 0 or act_labels[i] == 2) and (exp_labels[i] == 1):
        moto_FN.append(i)
    elif (act_labels[i] == 1) and (exp_labels[i] == 0 or exp_labels[i] == 2):
        moto_FP.append(i)
    if (act_labels[i] == 0 or act_labels[i] == 1) and (exp_labels[i] == 2):
        elef_FN.append(i)
    elif (act_labels[i] == 2) and (exp_labels[i] == 0 or exp_labels[i] == 1):
        elef_FP.append(i)
